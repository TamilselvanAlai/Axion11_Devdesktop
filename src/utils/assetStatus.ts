 ...
 *  distinct from a fresh upload nobody has looked at yet. Revoking an approval also lands here
 *  (status resets to "draft"), the same starting state as before anyone reviewed it. */
